import{j as e}from"./framer-motion-C5AbrVxp.js";import{L as t}from"./react-vendor-CpIpn6go.js";import{S as a}from"./scroll-area-Rk3LBTqo.js";import{C as o,a as r,b as i,c as s,B as n}from"./button-B9L-WLzI.js";import"./radix-CkZQtIg1.js";import"./index-DrQNTNco.js";const l=`
Terms of Use
...
Email: lb.850091@gmail.com
`,y=()=>e.jsx("div",{className:"min-h-screen bg-gradient-to-b from-[hsl(270,60%,16%)] via-background to-[hsl(270,60%,8%)]",children:e.jsxs("div",{className:"container max-w-3xl mx-auto py-8 px-4",children:[e.jsxs(o,{className:"border-border bg-card/95 backdrop-blur",children:[e.jsx(r,{children:e.jsx(i,{className:"text-2xl",children:"Terms of Use"})}),e.jsx(s,{children:e.jsx(a,{className:"h-[70vh] w-full rounded-md border border-border/50 p-4",children:e.jsx("div",{className:"prose prose-invert prose-sm max-w-none whitespace-pre-wrap text-muted-foreground leading-relaxed",children:l.trim()})})})]}),e.jsx("div",{className:"mb-6",children:e.jsx(n,{variant:"ghost",asChild:!0,children:e.jsx(t,{to:"/",children:"← Back to Game"})})})]})});export{y as default};
