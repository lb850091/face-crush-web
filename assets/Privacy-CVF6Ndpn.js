import{j as e}from"./framer-motion-C5AbrVxp.js";import{L as o}from"./react-vendor-CpIpn6go.js";import{B as r,C as a,a as s,b as t,c as i,S as n}from"./button-CVPOMPpE.js";import"./radix-CkZQtIg1.js";import"./index-fKP0_JXS.js";const c=`
Privacy Policy
...
`,y=()=>e.jsx("div",{className:"min-h-screen bg-gradient-to-b from-[hsl(270,60%,16%)] via-background to-[hsl(270,60%,8%)]",children:e.jsxs("div",{className:"container max-w-3xl mx-auto py-8 px-4",children:[e.jsx("div",{className:"mb-6",children:e.jsx(r,{variant:"ghost",asChild:!0,children:e.jsx(o,{to:"/",children:"← Back to Game"})})}),e.jsxs(a,{className:"border-border bg-card/95 backdrop-blur",children:[e.jsx(s,{children:e.jsx(t,{className:"text-2xl",children:"Privacy Policy"})}),e.jsx(i,{children:e.jsx(n,{className:"h-[70vh] w-full rounded-md border border-border/50 p-4",children:e.jsx("div",{className:"prose prose-invert prose-sm max-w-none whitespace-pre-wrap text-muted-foreground leading-relaxed",children:c.trim()})})})]})]})});export{y as default};
